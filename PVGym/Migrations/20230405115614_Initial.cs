    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2c6df428-51eb-482a-a508-7dc7efe1c4a6"), "The class is designed to provide a full-body workout while also keeping participants engaged and motivated. Zumba is suitable for people of all fitness levels, as the routines can be modified to suit individual needs.", 60, "https://imgmedia.lbb.in/media/2021/01/5ffc657c8cb26612da74e667_1610376572334.jpg", 30, "Zumba" },
                    { new Guid("4a3205ba-36b1-4e69-a1f1-9161351b45a7"), "Body Combat is a high-intensity, cardio-based fitness class that combines various martial arts techniques such as karate, boxing, and kickboxing.", 30, "https://www.fitnessfirst.co.uk/media/l2yngpvt/web-version-bodycombat-launch-kit-image-2.jpg?width=1200&height=1200&rnd=132955692406170000", 20, "Body Combat" },
                    { new Guid("bfeb0c43-b580-4e38-8df9-5388b3948555"), "Pilates is a low-impact fitness class that focuses on developing core strength, flexibility, and balance.", 60, "https://www.clubpilates.com/hubfs/11_studio_reformer-1.jpg", 40, "Pilates" },
                    { new Guid("e07a75da-0e55-4612-a5da-2d55654cad12"), "The class is designed to increase flexibility, strength, and balance while also reducing stress and improving mental clarity.", 60, "https://i2-prod.nottinghampost.com/whats-on/whats-on-news/article1239433.ece/ALTERNATES/s1200c/yoga-GettyImages-846236570.jpg", 30, "Yoga" }
                });

            migrationBuilder.InsertData(
                table: "Member",
                columns: new[] { "MemberId", "ClassId", "PlanType", "VAT" },
                values: new object[,]
                {
                    { new Guid("2d5e9e9f-c73b-4c68-959c-73d1e6b80bea"), null, 1, 234234586 },
                    { new Guid("34ba67ed-c192-44b9-a533-57ba13afd533"), null, 0, 222222213 }
                });
