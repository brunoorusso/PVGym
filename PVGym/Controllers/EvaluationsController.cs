...
namespace PVGym.Controllers
{
    public class EvaluationsController : Controller
    {
        ...
        public EvaluationsController(PVGymContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Evaluation != null ? 
                          ...
                          Problem("Entity set 'PVGymContext.Evaluation'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MemberId,Height,Weight,BMI,BodyFat")] Evaluation evaluation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,MemberId,Height,Weight,BMI,BodyFat")] Evaluation evaluation)
        {
            if (id != evaluation.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'PVGymContext.Evaluation'  is null.");
            }
            var evaluation = await _context.Evaluation.FindAsync(id);
            if (evaluation != null)
            {
