...
namespace PVGym.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VAT,PlanType")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VAT,PlanType")] Member member)
        {
            if (id != member.Id)
            {
                return NotFound();
