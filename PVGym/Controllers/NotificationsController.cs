...
namespace PVGym.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public NotificationsController(PVGymContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MemberId,NotificationDate,Content")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,MemberId,NotificationDate,Content")] Notification notification)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'PVGymContext.Notification'  is null.");
            }
            var notification = await _context.Notification.FindAsync(id);
            if (notification != null)
            {
